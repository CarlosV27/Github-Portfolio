...
{
	this->string_month = Date2.get_string_month();
	this->string_hour = Date2.get_string_hour();
	this->day = Date2.get_day();
	this->num_month = Date2.get_num_month();
	this->hour = Date2.get_hour();
	this->minute = Date2.get_minute();
	this->seconds = Date2.get_seconds();
}
